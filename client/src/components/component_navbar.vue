...
const submitQuery = (e: Event) => {
  e.preventDefault()
  charatersStore.searchCharaters(query.value)
...
<style scoped>
  ...
  span, .link { color: var(--secondary-color); }
  span { padding: 0px 4px; }
  .unformatted-link, .unformatted-link:visited{text-decoration: none; color: initial;}
</style>